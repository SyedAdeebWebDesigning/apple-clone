...
const CategoryBanner = () => {
	return (
		<div className=" bg-[#f5f5f7]  overflow-scroll">
			<div className="flex gap-2 mx-10 lg:ml-[140px] overflow-x-auto snap-x snap-mandatory scroll-smooth touch-pan-x [-webkit-overflow-scrolling:touch]">
