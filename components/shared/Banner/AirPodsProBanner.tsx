...
const AirPodsProBanner = () => {
	return (
		<div className="h-[400px] sm:h-[600px] flex flex-col justify-center items-center text-center px-4 overflow-hidden z-0 relative bg-[#f6f6f8] AirPodsProBannerBg">
			<div className="absolute bottom-0 left-0 right-0 flex justify-center min-[1172px]:hidden">
				<div className="relative h-[300px] min-[600px]:h-[500px] flex items-center justify-center w-full px-10">
					<Image
						src="/assets/banner/airpods-pro-banner.webp"
...
export default AirPodsProBanner;
