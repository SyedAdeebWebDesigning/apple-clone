	...
	return (
		<div className="mt-20 relative">
			<h1 className="font-semibold lg:px-[140px] mx-3 lg:mx-0">
				Personalization.{" "}
				<span className="text-neutral-500">Make it one of a kind.</span>
			</h1>
			...
			<div
				...
				{GroupBannerLinks.map((link, index) => (
					<Link
						...
						key={index}
						className={cn(
							"shrink-0 transition-all duration-500 hover:scale-100 scale-99 relative snap-center w-[313px] h-[500px] bg-white rounded-xl flex items-center justify-center text-neutral-500 font-medium",
